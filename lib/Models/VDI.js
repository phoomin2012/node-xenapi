  ...
  VDI = (function() {
    ...
    * @param      {Object}   xenAPI - An instance of XenAPI.
    ...
    function VDI(_session, _vdi, _opaqueRef, _xenAPI) {
      ...
      this.SR = _vdi.SR;
      this.is_a_snapshot = _vdi.is_a_snapshot;
      this.is_tools_iso = _vdi.is_tools_iso;
      this.read_only = _vdi.read_only;
      this.type = _vdi.type;
      this.physical_utilisation = _vdi.physical_utilisation;
    }
