...
(function () {
  ...
  VIF = (function () {
    ...
    function VIF(_session, _vif, _opaqueRef, _xenAPI) {
      ...
      this.allowed_operations = _vif.allowed_operations;
    ...
    VIF.prototype.toJSON = function () {
      return {
        ...
        ipv4_configuration_mode: this.ipv4_configuration_mode,
        ipv4_addresses: this.ipv4_addresses,
        ipv4_gateway: this.ipv4_gateway,
        other_config: {},
        qos_algorithm_type: "",
    ...
    VIF.prototype.config_ipv4 = function (ip, gateway) {
      return new Promise((function (_this) {
        return function (resolve, reject) {
          return session.request("VIF.configure_ipv4", [_this.opaqueRef, 'Static', ip, gateway]).then(function (value) {
            debug(value);
            return resolve();
          })["catch"](function (e) {
            debug(e);
