...
(function() {
  ...
  NetworkCollection = (function() {
    ...
    * @param      {Object}   xenAPI - An instance of XenAPI
    ...
    NetworkCollection.prototype.findUUID = function(uuid) {
      debug("findUUID(" + uuid);
      return new Promise((function(_this) {
        return function(resolve, reject) {
          return _this.list().then(function(Networks) {
            var filtered, matchNetworkUuid, matches;
            matchNetworkUuid = function(network) {
              if (network.uuid === uuid) {
                return network;
              }
            };
            matches = _.map(Networks, matchNetworkUuid);
            filtered = _.filter(matches, function(network) {
              return network;
            });
