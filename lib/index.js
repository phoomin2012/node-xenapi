...
(function() {
  var APIClient, GuestMetrics, GuestMetricsCollection, Metrics, MetricsCollection, Network, NetworkCollection, Pool, PoolCollection, SR, SRCollection, Session, Task, TaskCollection, Template, TemplateCollection, VBD, VBDCollection, VDI, VDICollection, VIF, VIFCollection, VM, VMCollection, xmlrpc;
  ...
  module.exports = function(options) {
    var apiClient, guestMetricsCollection, metricsCollection, networkCollection, poolCollection, session, srCollection, taskCollection, templateCollection, vbdCollection, vdiCollection, vifCollection, vmCollection, xenAPI;
