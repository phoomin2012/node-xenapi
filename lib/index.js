...
(function() {
  var APIClient, Network, NetworkCollection, Pool, PoolCollection, SR, SRCollection, Session, Task, TaskCollection, Template, TemplateCollection, VIF, VIFCollection, VM, VMCollection, xmlrpc;
  ...
  module.exports = function(options) {
    var apiClient, networkCollection, poolCollection, session, srCollection, taskCollection, templateCollection, vifCollection, vmCollection, xenAPI;
