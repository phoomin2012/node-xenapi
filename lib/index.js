...
(function() {
  var APIClient, GuestMetrics, GuestMetricsCollection, Network, NetworkCollection, Pool, PoolCollection, SR, SRCollection, Session, Task, TaskCollection, Template, TemplateCollection, VBD, VBDCollection, VDI, VDICollection, VIF, VIFCollection, VM, VMCollection, xmlrpc;
  ...
  module.exports = function(options) {
    var apiClient, guestMetricsCollection, networkCollection, poolCollection, session, srCollection, taskCollection, templateCollection, vbdCollection, vdiCollection, vifCollection, vmCollection, xenAPI;
